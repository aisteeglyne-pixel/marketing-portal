      ...
      <div className="card" style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            ...
            background: 'var(--brand-600)', margin: '0 auto 1rem',
          ...
          <h1 style={{ fontSize: 22, fontWeight: 600, color: '#111' }}>Klientų portalas</h1>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          {error && (
            <div style={{ background: '#FCEBEB', color: '#791F1F', padding: '10px 12px', borderRadius: 8, fontSize: 13 }}>
              {error}
            </div>
          )}
